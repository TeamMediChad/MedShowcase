const mensuales = [
    ...
    ['r', ['barboach','https://img.pokemondb.net/sprites/black-white/anim/shiny/barboach.gif'],'AshFifero'],
    ...
    ['r', ['corsola','https://media.giphy.com/media/OYuBjj4gY4R0OlarUz/giphy.gif'],'Ferbus'],
