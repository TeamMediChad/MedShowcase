function renderShinydex(){
    ...
    topImg.src = `https://raw.githubusercontent.com/TeamMediChad/MedShowcaseDB/refs/heads/main/Members_sprites/${topData.trainer}.png`;
    ...
    for (const [genName, pokemonList] of Object.entries(generations)) {
        ...
        if (Object.keys(capturedBy).includes(name)) {
            ...
            userImg.src = `https://raw.githubusercontent.com/TeamMediChad/MedShowcaseDB/refs/heads/main/Members_sprites/${registrador}.png`;
