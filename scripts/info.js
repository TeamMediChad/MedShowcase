...
const memberData = {
        ...
        aeamanh: {      name:'aeamanh',
                        rol: 'MaxiChad',
                        medallas:['m_secret','m_raceL','m_suertudo','m_sequia','m_pecador','m_apostol','m_olimpiadas','m_shinywar'],
        ...
        Akalii: {    name:'Akalii',
                        rol: 'Chad',
                        medallas:['m_gomed','m_lider','m_guardian','m_secret','m_pescador','m_raceL','m_suertudo','m_huevo','m_raza','m_pecador','m_apostol'],
        ...
        Azathotx: {     name:'Azathotx',
                        ...
                        shinys:['lotad','cacnea','dustox','cinccino','bidoof','mismagius','gastrodon','mienfoo','spinda','venomoth','vanillish','golduck','camerupt','boldore','dugtrio','poochyena',
                                'smeargle','dusclops','weezing','parasect','scolipede','beedrill','eelektrik'],
        ...
        DavidCitos: {   name:'DavidCitos',
                        rol: 'Chad',
                        medallas:['m_shunter','m_suertudo','m_racha','m_abuelo','m_goldenbox','m_apostol','m_supremacy1','m_olimpiadas','m_supremacy2','m_shinywar'],
                        shinys:['lopunny','marill','trapinch','roserade','vulpix','hydreigon','magmar','poliwag','swablu','meowth','gyarados','grimer','weezing','weavile','pikachu','psyduck','mareep','miltank',
                                ...
                                'piloswine','zebstrika','snorunt','poliwag'
                        ],
                        perdidos: [],
        ...
        Doce: {         name:'Doce',
                        ...
                        shinys:['crobat','litwick','altaria','ditto','raticate','ditto','shuppet','smeargle','duskull','vanillish'],
        ...
        Dohrito: {      name:'Dohrito',
                        rol: 'Chad',
                        medallas:['m_meditite','m_secret','m_shunter','m_raceL','m_rare','m_supremacy2'],
        ...
        ermifeNoPremium: {name:'ermifeNoPremium',
                        ...
                        shinys:['gyarados','lunatone','rattata','gothorita','rhyperior','jigglypuff','litwick','horsea','sewaddle','raticate'],
                        destacados:[],
                        perdidos: [],
                        vendidos: []
        },
        ...
        Ferbus: {       name:'Ferbus',
                        rol:'Chad',
                        medallas:['m_meditite','m_swarm','m_secret','m_suertudo'],
        ...
        Ingrid: {       name:'Ingrid',
                        rol: 'Chad',
                        medallas:['m_raza','m_pvp','m_shinywar'],
        ...
        JuniorJMx: {    name:'JuniorJMx',
                        rol: 'GigaChad',
                        medallas:['m_guardian','m_meditite','m_safari','m_pescador','m_raceL','m_suertudo','m_racha','m_goldenbox','m_raza','m_apostol','m_aniMeD','m_shinywar'],
        ...
        Krampus: {      name:'Krampus',
                        rol: 'MegaChad',
                        medallas:['m_suertudo','m_pecador','m_apostol'],
                        shinys:['gigalith','altaria','raticate','politoed','victreebel','accelgor','quagsire','donphan','hydreigon','ludicolo','poliwrath','chandelure','magcargo','haxorus','darmanitan','psyduck','doduo',
                                'gyarados','smeargle','weezing','braviary','jellicent-f','raichu','rapidash','gurdurr','grimer','bellsprout','metapod','scraggy','cubchoo','piloswine','krokorok'
                        ],
                        destacados:[],
                        perdidos: [],
        ...
        KnowJiYong: {   name:'KnowJiYong',
                        rol: 'MaxiChad',
                        medallas:['m_gomed','m_guardian','m_secret','m_shunter','m_pescador','m_raceL','m_suertudo','m_huevo','m_raza','m_pecador','m_apostol','m_olimpiadas','m_supremacy2','m_shinywar'],
        ...
        MarkosW: {      name:'MarkosW',
                        ...
                        shinys:['sunflora','litwick','cryogonal','beedrill','ponyta','smeargle','koffing','tentacruel','psyduck','golett'],
                        destacados:[],
        ...
        Mexb: {         name:'Mexb',
                        rol: 'MegaChad',
                        medallas:['m_secret','m_raceL','m_suertudo','m_raza','m_apostol','m_shinywar'],
                        shinys:['dusclops','gallade','weezing','mienshao','dugtrio','ponyta','chandelure','scrafty','smeargle','spinda','poliwrath','accelgor','mienfoo','yamask','kricketune','cacnea'],
                        destacados:[{name: 'staryu', type: 'normal', link:'staryu'},
        ...
        Pancho: {       name: 'Pancho',
                        rol: 'MaxiChad',
                        medallas: ['m_gomed','m_lider','m_guardian','m_raceW','m_abuelo','m_raza','m_pecador','m_apostol','m_supremacy1','m_olimpiadas','m_supremacy2','m_shinywar'],
        ...
        rebukittheveil: {name:'rebukittheveil',
                        rol: 'Chad',
                        medallas:['m_pescador','m_suertudo','m_huevo','m_pecador','m_olimpiadas','m_supremacy2'],
                        shinys:['haxorus','manectric','camerupt','nidoqueen','lickitung','lanturn','luxio','vulpix','horsea','dragonair','krokorok','mienfoo','lilligant','golbat','seadra','krabby'],
        ...
        Reimy: {        name:'Reimy',
                        ...
                        shinys:['gardevoir','haxorus','torkoal','ninetales','flygon','oddish','elgyem','clamperl','snorunt','glameow','lunatone'],
                        destacados:[{name:'remoraid', type:'secret', link:'https://media.giphy.com/media/EnYSne4KwCFQREgo96/giphy.gif'}],
        ...
        ritosenpai: {   name:'ritosenpai',
                        rol: 'MaxiChad',
                        medallas:['m_gomed','m_secret','m_shunter','m_raceL','m_suertudo','m_abuelo','m_goldenbox','m_raza','m_apostol','m_supremacy1','m_olimpiadas','m_supremacy2','m_shinywar'],
                        shinys:['slugma','mienfoo','mienfoo','mienfoo','mienfoo','volbeat','shelmet','voltorb','politoed','deino','bellsprout','linoone','weepinbell','drifblim','houndour','zigzagoon','zigzagoon','wynaut',
                                ...
                                'surskit','pidove','clamperl','mightyena','golbat','lunatone','lunatone','ralts'
                        ],
        ...
        Salva: {        name:'Salva',
                        rol: 'Chad',
                        medallas:['m_swarm','m_secret','m_pescador','m_pecador','m_apostol','m_shinywar'],
        ...
        Souen: {        name:'Souen',
                        rol: 'Lider',
                        medallas:['m_gomed','m_lider','m_guardian','m_meditite','m_swarm','m_secret','m_pescador','m_raceL','m_suertudo','m_racha','b35','m_abuelo','m_huevo','m_raza','m_pecador','m_apostol','m_olimpiadas'],
                        shinys:['pidgeot','chandelure','ditto','amoonguss','scolipede','ninetales','crobat','arcanine','rapidash','golem','roserade','slugma','crobat','graveler','rapidash','weezing','tentacruel','ditto',
                                'shellos-east','bibarel','kricketune','oddish','bibarel','misdreavus','smeargle','woobat','mienfoo','jellicent-f','nidorino','luxio','meditite','cubchoo','cryogonal','petilil'
                        ],
        ...
        TheJesucristian: {name:'TheJesucristian',
                        rol: 'Chad',
                        medallas:['m_gomed','m_suertudo','m_rare','m_huevo','m_raza','m_apostol'],
