...
const memberData = {
        ...
        emirfeNoPremium: {name:'emirfeNoPremium',
                        ...
                        shinys:['gyarados','lunatone','rattata','gothorita','rhyperior','jigglypuff','litwick','horsea','sewaddle','raticate','mankey','swablu','ditto','sealeo','sneasel'],
        ...
        ErnestoSwampert: {name:'ErnestoSwampert',
                        ...
                        shinys:['nidoking','gyarados','poliwag','weavile','mienshao','weezing','beedrill','marill','jigglypuff','smeargle','banette','parasect','wingull','spinarak','shelmet','persian','graveler','marill','litwick','gliscor',
                                'poliwhirl','poliwhirl','golett','raticate','nidorina','kricketune'
                        ],
        ...
        Farithi: {      name:'Farithi',
                        rol: 'Chad',
                        medallas:['m_secret'],
                        shinys:['leavanny','banette','chandelure'],
        ...
        HoraxPC: {      name:'HoraxPC',
                        ...
                        shinys:['haxorus','klink','klinklang','chandelure','onix','onix','joltik','deino','parasect'],
        ...
        MarkosW: {      name:'MarkosW',
                        ...
                        shinys:['sunflora','litwick','cryogonal','beedrill','ponyta','smeargle','koffing','tentacruel','psyduck','golett','clefable','vanilluxe','woobat','woobat','axew'],
        ...
        Seaba: {        name:'Seaba',
                        ...
                        shinys:['gigalith','chandelure','solrock','jynx','crobat','dusknoir','haxorus','hydreigon','gyarados','smeargle','psyduck','gardevoir','liepard','gothitelle','cinccino','jumpluff','masquerain',
                                'accelgor','petilil','wingull','cacnea','darumaka','electrike','cubchoo','nidoran-m','shellos-east','shellos-east'
                        ],
        ...
        ToxicPlumber: { name:'ToxicPlumber',
                        ...
                        shinys:['krookodile','raticate','venipede','weezing','nidoqueen','quagsire','altaria','kingdra','pichu','rattata','seaking','machamp','smeargle','gengar','chandelure','pidgey','ferrothorn','aggron',
                                ...
                                'gigalith','vileplume','maractus','manectric','marowak','xatu','gyarados','baltoy','voltorb','lunatone','tyranitar','spinda','raticate','graveler','gloom','dodrio'
                        ],
        ...
        YankiX: {       name:'YankiX',
                        rol: 'Chad',
                        medallas:['m_egg'],
                        shinys:['weezing','smeargle'],
                        destacados:[{name: 'armaldo', type:'egg', link:'https://media.giphy.com/media/i55EdF4KLJp0GROR8g/giphy.gif'}],
                        perdidos: [],
                        vendidos: []
        },
