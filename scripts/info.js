...
const memberData = {
        AdrixJK: {      name:'AdrixJK',
                        rol: 'MegaChad',
                        medallas:['b9','b10','b14','b15','b24','b26','b32'],
                        shinys:['raticate','ditto','raticate','buizel','ditto','gloom','smeargle'],
                        destacados:[],
                        perdidos: [],
                        vendidos: [],
        },
        aeamanh: {      name:'aeamanh',
                        ...
                        shinys:['donphan','sandslash','scolipede','raticate','tangrowth','spinda','raticate','mienfoo','frillish-f','smeargle','nidoking','ditto','grimer',
                                ...
                                'politoed','duskull','duosion','mightyena','gliscor','gyarados','amoonguss','hippowdon','illumise','loudred','stunfisk'],
        ...
        Akalii: {    name:'Akalii',
                        ...
                        shinys:['tyranitar','horsea','duskull','mienshao','sharpedo','ninetales','poochyena','beedrill','cottonee','slugma','wooper','azumarill','gyarados','shinx','snorunt',
                                'weavile','axew','pachirisu','lanturn','cottonee','torkoal','gible','jumpluff','weezing','bibarel','vulpix','loudred','ralts','cascoon','scraggy'],
                        destacados:[{name: 'gulpin', type: 'normal', link:'gulpin'},
        ...
        Alicia: {       name:'Alicia',
                        rol: 'Chad',
                        medallas:['b1','b4','b5','b12','b15','b19','b24','b26','b28','b29','b30'],
        ...
        Ashy: {         name:'Ashy',
                        ...
                        shinys:['drifblim','dratini','raticate','gardevoir','duskull','marill','smeargle','scolipede','zangoose','staravia','bellossom','gloom','lanturn','golett','scraggy','swablu'],
        ...
        Azathotx: {     name:'Azathotx',
                        rol: 'Chad',
                        medallas:['b1','b8','b14','b19','b26','b29'],
        ...
        Cece: {         name:'Cece',
                        ...
                        shinys:['sneasel','meditite','luxray','girafarig','wingull','magmar','deerling','golett','weedle','purrloin','dratini','bronzong','jynx','cofagrigus','hypno'],
                        destacados:[],
                        perdidos: [],
                        vendidos: []
        },
        ...
        DavidCitos: {   name:'DavidCitos',
                        ...
                        shinys:['lopunny','marill','trapinch','roserade','vulpix','hydreigon','magmar','poliwag','swablu','meowth','gyarados','grimer','weezing','weavile','pikachu','psyduck','mareep','miltank',
                                ...
                                'golbat','mankey','girafarig','lunatone','gloom','fearow','gloom','lunatone','spinda','golduck','machoke','lombre','growlithe','kadabra','misdreavus','golbat','floatzel','haunter','lairon'
                        ],
                        perdidos: [],
        ...
        Guabixd: {      name:'Guabixd',
                        rol: 'Chad',
                        medallas:['b14','b15','b16','b24','b26'],
                        shinys:['bibarel','gothita','budew','zigzagoon','heatmor','ditto','seedot','rufflet','golett','frillish-m','scraggy'],
                        destacados:[],
                        perdidos: [],
        ...
        Ingrid: {       name:'Ingrid',
                        ...
                        shinys:['raticate','pikachu','clefairy','jigglypuff','meowth','arcanine','gengar','onix','kingler','koffing','gyarados','gyarados','crobat','azumarill','politoed','gligar','kingdra','stantler','smeargle',
                                ...
                                'ferroseed','litwick','chandelure','haxorus','beartic','mienfoo','mienshao','mandibuzz','durant','hydreigon','hydreigon'
                        ],
                        destacados:[],
                        perdidos: [],
                        vendidos: []
        ...
        Jabubuu: {      name:'Jabubuu',
                        rol: 'MegaChad',
                        medallas:['b1','b9','b10','b11','b15','b16','b18','b19','b24','b26','b33'],
        ...
        JJean: {        name:'JJean',
                        rol: 'Chad',
                        medallas:['b10','b15','b19','b23','b26','b30','b31','b33'],
        ...
        JuniorJMx: {    name:'JuniorJMx',
                        rol: 'GigaChad',
                        medallas:['b5','b6','b7','b12','b14','b15','b16','b26','b23','b31','b33'],
                        shinys:['tentacruel','tentacruel','watchog','kricketune','golduck','smeargle','banette','weezing','torkoal','pelipper','petilil','gothitelle','graveler','vanilluxe','chandelure','rhyperior',
                                ...
                                'girafarig','lunatone','meditite','parasect','ditto','ditto','cacnea','pachirisu'
                        ],
        ...
        Krampus: {      name:'Krampus',
                        ...
                        shinys:['gigalith','altaria','raticate','politoed','victreebel','accelgor','quagsire','donphan','hydreigon','ludicolo','poliwrath','chandelure','magcargo','haxorus','darmanitan','psyduck','doduo',
                                'gyarados','smeargle','weezing','braviary','jellicent-f','raichu','rapidash','gurdurr','grimer','bellsprout','metapod','scraggy'
                        ],
                        destacados:[],
                        perdidos: [],
        ...
        KnowJiYong: {   name:'KnowJiYong',
                        rol: 'MaxiChad',
                        medallas:['b1','b5','b10','b11','b12','b14','b15','b19','b24','b26','b29','b30','b33'],
        ...
        LauraSkylar: {  name:'LauraSkylar',
                        rol: 'Chad',
                        medallas:['b1','b7','b9','b15','b26','b33'],
                        shinys:['lanturn','roserade','geodude','golem','donphan','braviary','pelipper','volbeat','sigilyph','minccino','cinccino','whismur','trubbish'],
        ...
        Lirio: {        name:'Lirio',
                        ...
                        shinys:['ampharos','froslass','altaria','ninetales','wigglytuff','crobat','manectric','spinda','haxorus','hydreigon','ditto','garchomp','gyarados','kingdra','pikachu','krookodile',
                                ...
                                'poliwrath','ludicolo','lanturn','nidoking','solrock','torkoal','cottonee','diglett','smeargle'
                        ],
        ...
        nyumichaelis: {name:'nyumichaelis',
                        rol: 'Chad',
                        medallas:['b1','b12','b10','b15','b18','b24','b26','b29','b33'],
        ...
        OniED: {        name:'OniED',
                        rol: 'Chad',
                        medallas:['b10','b12','b15','b16','b18','b19','b24','b33'],
                        shinys:['weavile','tentacruel','amoonguss','sandslash','gligar','grimer','koffing','meowth','poochyena','zigzagoon','pelipper','wingull','mienshao','ditto','accelgor','ledyba','hoothoot',
                                'bellsprout','scolipede','sewaddle','lotad','golett','slugma','claydol'
                        ],
        ...
        Pancho: {       name: 'Pancho',
                        rol: 'MaxiChad',
                        medallas: ['b1','b4','b5','b13','b18','b24','b26','b28','b29','b30','b33'],
        ...
        rebukittheveil: {name:'rebukittheveil',
                        ...
                        shinys:['haxorus','manectric','camerupt','nidoqueen','lickitung','lanturn','luxio','vulpix','horsea','dragonair','krokorok','mienfoo','lilligant','golbat','seadra'],
                        destacados:[{name: 'charizard', type: 'egg', link:'https://media.giphy.com/media/kI6DHEnVibteJcUDtY/giphy.gif'}
                        ],
                        perdidos: [],
        ...
        Reimy: {        name:'Reimy',
                        rol: 'Chad',
                        medallas:['b9','b10','b12','b15','b16','b24','b26'],
        ...
        ritosenpai: {   name:'ritosenpai',
                        rol: 'MaxiChad',
                        medallas:['b1','b10','b11','b14','b15','b18','b23','b26','b28','b29','b30','b33'],
        ...
        Salva: {        name:'Salva',
                        rol: 'Chad',
                        medallas:['b8','b10','b12','b24','b26'],
                        shinys:['haxorus','ninetales','gigalith','litwick','weezing','swellow','torkoal','smeargle','bibarel','golurk','elgyem','electrode','magikarp','krabby','shelmet'],
                        destacados:[{name:'corphish', type:'normal', link:'corphish'},
        ...
        Seaba: {        name:'Seaba',
                        rol: 'Chad',
                        medallas:['b7','b8','b15','b16','b18','b19','b26'],
                        shinys:['gigalith','chandelure','solrock','jynx','crobat','dusknoir','haxorus','hydreigon','gyarados','smeargle','psyduck','gardevoir','liepard','gothitelle','cinccino','jumpluff','masquerain',
                                'accelgor','petilil','wingull','cacnea','darumaka','electrike'
                        ],
        ...
        Souen: {        name:'Souen',
                        rol: 'Lider',
                        medallas:['b1','b4','b5','b6','b8','b10','b12','b14','b15','b16','b18','b19','b24','b26','b29','b33'],
                        shinys:['pidgeot','chandelure','ditto','amoonguss','scolipede','ninetales','crobat','arcanine','rapidash','golem','roserade','slugma','crobat','graveler','rapidash','weezing','tentacruel','ditto',
                                'shellos-east','bibarel','kricketune','oddish','bibarel','misdreavus','smeargle','woobat','mienfoo','jellicent-f','nidorino','luxio','meditite'
                        ],
        ...
        Tyrantrum: {    name:'Tyrantrum',
                        ...
                        shinys:['drifblim','donphan','arbok','druddigon','roselia','tentacool'],
        ...
        UltimoMorador: {name:'UltimoMorador',
                        ...
                        shinys:['bellossom','escavalier','litwick','donphan','machamp','graveler','graveler','weezing','dodrio','hariyama','masquerain','igglybuff','snubbull','mantyke','clamperl','marill','boldore','scraggy',
                                'tranquill','wobbuffet','smoochum','patrat','persian','sawk','xatu','makuhita','joltik','stoutland'
                        ],
                        destacados:[],
                        perdidos: [],
                        vendidos: []
        ...
        wallycbammo: {  name:'wallycbammo',
                        rol: 'Chad',
                        medallas:['b26'],
                        shinys:['pelipper','wurmple','wooper'],
