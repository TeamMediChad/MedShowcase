...
function showInfo(personKey = "Palafo") {
  //disableScroll()
  ...
  modal_name.style = ""
  document.getElementById('modal-title2').innerHTML = `Shinys (${shinys.length + destacados.length})`;
...
function show_shiny() {
  ...
  if(document.getElementById('shiny-container').classList[1] == 'hidden'){
    ...
    document.getElementById('modal-title2').innerHTML = `Shinys (${memberData[nombre].shinys.length + memberData[nombre].destacados.length})`;
    document.getElementById('modal-title2').style = ""
  }
}
